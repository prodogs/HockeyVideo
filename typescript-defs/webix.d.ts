...
declare module webix {
	...
	function $$(id: string|Event|HTMLElement):webix.ui.contextmenu;
	...
	function alert(object : any ):HTMLElement;
	...
	function confirm(obj : any):HTMLElement;
	...
	function event(node:any, event:string, handler:WebixCallback, master?:any):string;
	...
	function message(text:string, text2?:string):void;
	function message(message:any):void;

	function modalbox(text:string):HTMLElement;

	function modalbox(message:any):HTMLElement;
	...
	function proxy(type:string, source:any):any;
...
declare function $$(id: string|Event|HTMLElement): any;