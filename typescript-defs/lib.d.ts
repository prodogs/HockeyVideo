...
interface ErrorEventHandler {
  //  (event: Event, source: string, fileno: number, columnNumber: number): void;
    (message: any, uri: string, lineNumber: number, columnNumber?: number, error? : Error): void;
}
...
/////////////////////////////
// TODO: These are only available in a Web Worker - should be in a separate both file
